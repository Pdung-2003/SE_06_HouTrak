...
public class ThemNhanKhau extends JPanel {
	...
	public ThemNhanKhau() {
		...
		textField_TNK_CotPhai_02.setText("   Nhập địa chỉ của hộ khẩu");
		...
		textField_TNK_CotPhai_03.setText("   Nhập họ và tên nhân khẩu");
		...
		textField_TNK_CotPhai_04.setText("   Nhập số CCCD/CMND của nhân khẩu");
		...
		JPanel panel_TNK_NgaySinh_Dem = new JPanel();
		panel_TNK_NgaySinh_Dem.setBackground(Colors.khung_Chung);
		panel_TNK_CotPhai_NhanKhau_NgaySinh.add(panel_TNK_NgaySinh_Dem);
		...
		textField_TNK_CotPhai_05.setText("   Nhập tôn giáo của nhân khẩu");
		...
		textField_TNK_CotPhai_06.setText("     Nhập quê quán nhân khẩu");
