...
public class XoaKhoanThu extends JPanel {
	...
	public XoaKhoanThu() {
		...
		panel_KhungNoiDungXKT.setBorder(new LineBorder(Colors.khung_Chung, 5, true));
		...
		lbl_XKT_SearchBar_Method_Title.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		lbl_XKT_SearchBar_ByReason_Title.setFont(new Font("Arial", Font.PLAIN, 20));
		panel_XKT_SearchBar_ByReason_Title.add(lbl_XKT_SearchBar_ByReason_Title);
		
		textField_XKT_SearchBar_ByReason = new JTextField();
		textField_XKT_SearchBar_ByReason.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		lbl_XKT_SearchBar_ByTime_Title.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		lbl_XKT_SearchBar_ByTime_Thang.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		comboBox_XKT_SearchBar_ByTime_Thang.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		lbl_XKT_SearchBar_ByTime_Nam.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		comboBox_XKT_SearchBar_ByTime_Nam.setFont(new Font("Arial", Font.PLAIN, 20));
		...
		btn_XKT_SearchBar_ByTime.setFont(new Font("Arial", Font.PLAIN, 20));
