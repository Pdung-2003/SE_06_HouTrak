...
public class SignIn extends JPanel {
	...
	private JTextField textField_SignIn_MK;
	...
	public SignIn() {
		...
		textField_SignIn_MK = new JTextField();
		textField_SignIn_MK.setBackground(Colors.input_Colors);
		panel_SignIn_Password.add(textField_SignIn_MK, BorderLayout.CENTER);
		textField_SignIn_MK.setColumns(10);
