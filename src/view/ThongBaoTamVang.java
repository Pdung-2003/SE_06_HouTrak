...
//		panel_TBTV_02_CotPhai_02.add(text_TBTV_02_CotPhai_02, BorderLayout.CENTER);
		...
		Dimension tableSize = new Dimension(1100, 40);
		...
		Dimension scrollPaneSize = new Dimension(1100, 40);
				...
				if (confirmResult == JOptionPane.YES_OPTION) {
					...
					try (Connection connection = DatabaseConnector.getConnection()) {
						if (connection != null) {
							...
							preparedStatement.setDate(3, ngayBatDauSQL); // Tạo chuỗi ngày bắt đầu
							preparedStatement.setDate(4, ngayKetThucSQL); // Tạo chuỗi ngày bắt đầu
							preparedStatement.setString(5, noiTamTru);

							int rowsAffected = preparedStatement.executeUpdate();
							if (rowsAffected > 0) {
								JOptionPane.showMessageDialog(mainFrame, "Thông báo tạm vắng thành công!");
								textField_TBTV_01.setText("");
								textField_TBTV_02.setText("");
								comboBox_TBTV_02_CotPhai_05_NoiDung_Nam.setSelectedItem(1900);
								comboBox_TBTV_02_CotPhai_05_NoiDung_Thang.setSelectedItem(1);
								comboBox_TBTV_02_CotPhai_05_NoiDung_Ngay.setSelectedItem(1);
								comboBox_TBTV_02_CotPhai_06_NoiDung_Nam.setSelectedItem(1900);
								comboBox_TBTV_02_CotPhai_06_NoiDung_Thang.setSelectedItem(1);
								comboBox_TBTV_02_CotPhai_06_NoiDung_Ngay.setSelectedItem(1);

							} else {
								JOptionPane.showMessageDialog(mainFrame, "Thêm thông báo tạm vắng không thành công!");
							}
