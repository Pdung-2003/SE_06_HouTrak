...
public class ThongBaoTamVang extends JPanel {
	...
	private JTextField textField_TBTV_02_CotPhai_04;
	...
	public ThongBaoTamVang(ManHinhChinh mainFrame) {
		...
		panel_TBTV_02_BangThongTin_CotTrai.setLayout(new GridLayout(6, 1, 10, 10));
		...
		panel_TBTV_02_BangThongTin_CotPhai.setLayout(new GridLayout(6, 1, 10, 10));

		JLabel lbl_TBTV_02_BangThongTin_CotPhai_HoTen = new JLabel("New label");
		lbl_TBTV_02_BangThongTin_CotPhai_HoTen.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_TBTV_02_BangThongTin_CotPhai.add(lbl_TBTV_02_BangThongTin_CotPhai_HoTen);

		JLabel lbl_TBTV_02_BangThongTin_CotPhai_NgaySinh = new JLabel("New label");
		lbl_TBTV_02_BangThongTin_CotPhai_NgaySinh.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_TBTV_02_BangThongTin_CotPhai.add(lbl_TBTV_02_BangThongTin_CotPhai_NgaySinh);

		JLabel lbl_TBTV_02_BangThongTin_CotPhai_DiaChiHien = new JLabel("New label");
		lbl_TBTV_02_BangThongTin_CotPhai_DiaChiHien.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_TBTV_02_BangThongTin_CotPhai.add(lbl_TBTV_02_BangThongTin_CotPhai_DiaChiHien);
		...
		textField_TBTV_02_CotPhai_04 = new JTextField();
		textField_TBTV_02_CotPhai_04.setBackground(Colors.input_Colors);
		panel_TBTV_02_CotPhai_04.add(textField_TBTV_02_CotPhai_04, BorderLayout.CENTER);
		textField_TBTV_02_CotPhai_04.setColumns(10);
		...
		lbl_TBTV_02_CotPhai_05_NoiDung_Nam.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		lbl_TBTV_02_CotPhai_05_NoiDung_Thang.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		lbl_TBTV_02_CotPhai_05_NoiDung_Ngay.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		lbl_TBTV_02_CotPhai_06_NoiDung_Nam.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		lbl_TBTV_02_CotPhai_06_NoiDung_Thang.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		lbl_TBTV_02_CotPhai_06_NoiDung_Ngay.setFont(new Font("Arial", Font.PLAIN, 12));
