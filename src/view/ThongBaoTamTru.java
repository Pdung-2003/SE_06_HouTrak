...
public class ThongBaoTamTru extends JPanel {
	...
	public ThongBaoTamTru() {
		...
		textField_TBTT_CotPhai_02.setText("   Nhập địa chỉ của hộ khẩu");
		...
		txtNhpHV = new JTextField();
		txtNhpHV.setBackground(Colors.input_Colors);
		txtNhpHV.setFont(new Font("Arial", Font.PLAIN, 12));
		txtNhpHV.setText("   Nhập họ và tên người tạm trú");
		panel_TBTT_CotPhai_NhanKhau_01.add(txtNhpHV, BorderLayout.CENTER);
		txtNhpHV.setColumns(10);
		...
		textField_TBTT_CotPhai_04.setText("   Nhập số CCCD/CMND của người tạm trú");
		...
		JPanel panel_TBTT_NgaySinh_Dem = new JPanel();
		panel_TBTT_NgaySinh_Dem.setBackground(Colors.khung_Chung);
		panel_TBTT_CotPhai_NhanKhau_NgaySinh.add(panel_TBTT_NgaySinh_Dem);
		...
		textField_TBTT_CotPhai_05.setText("   Nhập tôn giáo của người tạm trú");
		...
		textField_TBTT_CotPhai_06.setText("     Nhập quê quán người tạm trú");
		...
		JPanel panel_TBTT_CotPhai_NhanKhau_ThoiGianBatDau_Dem = new JPanel();
		panel_TBTT_CotPhai_NhanKhau_ThoiGianBatDau_Dem.setBackground(Colors.khung_Chung);
		panel_TBTT_CotPhai_NhanKhau_ThoiGianBatDau.add(panel_TBTT_CotPhai_NhanKhau_ThoiGianBatDau_Dem);
		...
		JPanel panel_TBTT_CotPhai_NhanKhau_ThoiGianKetThuc_Dem = new JPanel();
		panel_TBTT_CotPhai_NhanKhau_ThoiGianKetThuc_Dem.setBackground(Colors.khung_Chung);
		panel_TBTT_CotPhai_NhanKhau_ThoiGianKetThuc.add(panel_TBTT_CotPhai_NhanKhau_ThoiGianKetThuc_Dem);
