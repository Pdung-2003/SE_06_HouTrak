...
public class TachHoKhau extends JPanel {
	...
	public TachHoKhau(ManHinhChinh mainFrame) {
		...
		JPanel panel_CotPhai_ThongTinDau_01_DiaChi = new JPanel();
		panel_CotPhai_ThongTinDau_01_DiaChi.setBackground(Colors.khung_Chung);
		panel_CotPhai_ThongTinDau_01.add(panel_CotPhai_ThongTinDau_01_DiaChi);
		
		JPanel panel_CotPhai_ThongTinDau_01_ChuHo = new JPanel();
		panel_CotPhai_ThongTinDau_01_ChuHo.setBackground(Colors.khung_Chung);
		panel_CotPhai_ThongTinDau_01.add(panel_CotPhai_ThongTinDau_01_ChuHo);
		...
		JLabel lblNewLabel_1 = new JLabel("   Địa chỉ mới: ");
		lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_CotPhai_ThongTinSau_Title_01.add(lblNewLabel_1);
		
		JLabel lblNewLabel = new JLabel("   Chủ hộ: ");
		lblNewLabel.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_CotPhai_ThongTinSau_Title_01.add(lblNewLabel);
		...
		JLabel lblNewLabel_2 = new JLabel("   Thành viên: ");
		lblNewLabel_2.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_CotPhai_ThongTinSau_Title_02.add(lblNewLabel_2);
		...
		JPanel panel_CotPhai_ThongTinSau_Content_01_DiaChi = new JPanel();
		panel_CotPhai_ThongTinSau_Content_01_DiaChi.setBackground(Colors.khung_Chung);
		panel_CotPhai_ThongTinSau_Content_01.add(panel_CotPhai_ThongTinSau_Content_01_DiaChi);
		
		JPanel panel_CotPhai_ThongTinSau_Content_01_ChuHo = new JPanel();
		panel_CotPhai_ThongTinSau_Content_01_ChuHo.setBackground(Colors.khung_Chung);
		panel_CotPhai_ThongTinSau_Content_01.add(panel_CotPhai_ThongTinSau_Content_01_ChuHo);
