...
public class CapNhatTamTru extends JPanel {
	...
	public CapNhatTamTru(ManHinhChinh mainFrame) {
		...
		JPanel panel_CNTT_KhoangTrang4 = new JPanel();
		panel_CNTT_KhoangTrang4.setBackground(Colors.input_Colors);
		panel_CNTT_01.add(panel_CNTT_KhoangTrang4, BorderLayout.EAST);
		...
		text_CNTT_01.setPreferredSize(new Dimension(1389, 48));
		text_CNTT_01.setMargin(new Insets(2, 20, 2, 2));
		text_CNTT_01.setHorizontalAlignment(SwingConstants.LEFT);
		text_CNTT_01.setForeground(Color.BLACK);
		text_CNTT_01.setFont(new Font("Tahoma", Font.PLAIN, 14));
		text_CNTT_01.setColumns(10);
		text_CNTT_01.setCaretColor(new Color(103, 103, 103));
		text_CNTT_01.setBorder(null);
		text_CNTT_01.setBackground(Colors.input_Colors);
		...
		lbl_CNTT_CotTrai_3.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_CNTT_CotTrai.add(lbl_CNTT_CotTrai_3);
		...
		panel_CNTT_CotPhai.setLayout(new GridLayout(10, 1, 5, 10));
		...
		panel_CNTT_CotPhai_NhanKhau_01.setLayout(new BorderLayout(0, 0));
		...
		textField_CNTT_CotPhai_04.setFont(new Font("Arial", Font.PLAIN, 12));
		textField_CNTT_CotPhai_04.setColumns(10);
		textField_CNTT_CotPhai_04.setBackground(new Color(217, 217, 217));
		panel_CNTT_CotPhai_NhanKhau_02.add(textField_CNTT_CotPhai_04, BorderLayout.CENTER);
		...
		panel_CNTT_CotPhai_NhanKhau_07.setLayout(new BorderLayout(0, 0));

		JLabel lbl_CNTT_CotPhai_07 = new JLabel("   Bắt đầu từ            ");
		lbl_CNTT_CotPhai_07.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_CNTT_CotPhai_NhanKhau_07.add(lbl_CNTT_CotPhai_07, BorderLayout.WEST);
		...
		lbl_CNTT_CotPhai_NhanKhau_ThoiGianBatDau_Nam.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		panel_CNTT_CotPhai_NhanKhau_08.setLayout(new BorderLayout(0, 0));

		JLabel lbl_CNTT_CotPhai_08 = new JLabel("   Kết thúc ngày       ");
		lbl_CNTT_CotPhai_08.setFont(new Font("Arial", Font.PLAIN, 12));
		panel_CNTT_CotPhai_NhanKhau_08.add(lbl_CNTT_CotPhai_08, BorderLayout.WEST);
		...
		panel_CNTT_CotPhai_NhanKhau_08.add(panel_CNTT_CotPhai_NhanKhau_ThoiGianKetThuc, BorderLayout.CENTER);
		...
		panel_CNTT_CotPhai_NhanKhau_ThoiGianKetThuc_NoiDung.setLayout(new BoxLayout(panel_CNTT_CotPhai_NhanKhau_ThoiGianKetThuc_NoiDung, BoxLayout.X_AXIS));

		JLabel lbl_CNTT_CotPhai_NhanKhau_ThoiGianKetThuc_Nam = new JLabel("Năm:        ");
		lbl_CNTT_CotPhai_NhanKhau_ThoiGianKetThuc_Nam.setFont(new Font("Arial", Font.PLAIN, 12));
		lbl_CNTT_CotPhai_NhanKhau_ThoiGianKetThuc_Nam.setBackground(new Color(128, 0, 0));
