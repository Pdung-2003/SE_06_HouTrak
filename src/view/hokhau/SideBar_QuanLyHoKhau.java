...
public class SideBar_QuanLyHoKhau extends JPanel {
	...
	public SideBar_QuanLyHoKhau(ManHinhChinh mainFrame) {
		...
		JButton btn_SB_QLHK = new JButton("  Quản lý hộ khẩu");
		...
		JPanel panel_SB_QLHK_dem_1 = new JPanel();
		panel_SB_QLHK_dem_1.setBackground(new Color(2, 62, 138));
		panel_SB_QLHK.add(panel_SB_QLHK_dem_1);
