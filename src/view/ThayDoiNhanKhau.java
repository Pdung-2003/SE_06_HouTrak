...
public class ThayDoiNhanKhau extends JPanel {
	...
	public ThayDoiNhanKhau() {
		...
		panel_TDNK_KhoangTrang1.setBackground(Colors.input_Colors);
		...
		text_TDNK_01.setText("Nhập mã số nhân khẩu muốn thay đổi");
		...
		textField_TDNK_02_ThayDoiThongTin_CotPhai_DiaChi.setText("   Nhập địa chỉ cần thay đổi");
		...
		textField_TDNK_02_ThayDoiThongTin_CotPhai_NhanKhau_HoVaTen.setText("   Nhập họ và tên nhân khẩu cần thay đổi");
		...
		textField_TDNK_02_ThayDoiThongTin_CotPhai_NhanKhau_CCCD.setText("   Nhập CCCD/CMND nhân khẩu cần thay đổi");
		...
		panel_TDNK_02_ThayDoiThongTin_Content_CotPhai_NhanKhau_NgaySinh.add(panel_Dem_10);
		...
		textField_TDNK_02_ThayDoiThongTin_CotPhai_NhanKhau_TonGiao.setText("   Nhập tôn giáo của nhân khẩu cần thay đổi");
		...
		textField_TDNK_02_ThayDoiThongTin_CotPhai_NhanKhau_QueQuan.setText("   Nhập quê quán nhân khẩu cần thay đổi");
